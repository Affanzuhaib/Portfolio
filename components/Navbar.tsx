    ...
    top-0 z-50 bg-bodyColor px-4 '>
        <div className='max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between'>
            ...
            <div className='hidden mdl:inline-flex items-center gap-7'>
                ...
                <a href='./assets/Affan_Zuhaib.pdf' target='_blank'>
                    <motion.button 
                        initial={{ opacity:0}} 
                        animate={{ opacity:1}} 
            ...
            text-4xl text-textGreen cursor-pointer overflow-hidden group '>
                ...
                <span className='w-full h-[2px] bg-textGreen inline-flex transform
                translate-x-1 group-hover:translate-x-2 transition-all ease-in-out duration-300 '></span>
            </div>
            {
                showMenu && (
                    <div 
                        ...
                        >
                            ...
                            <div className='flex flex-col items-center gap-7'>
                                ...
                                <div className="flex gap-4 ">
                                    <motion.a href="https://www.linkedin.com/in/affan-zuhaib-73b389209/" target="_blank">
                                    ...
                                    <motion.a href="https://leetcode.com/affanzuhaibuddin/" target="_blank">
                                        <span className="w-10 h-10 text-xl bg-bodyColor border-[1px]
                                        border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full 
                                        inline-flex items-center justify-center hover:text-textGreen 
                                        cursor-pointer hover:-translate-y-2 transition-all duration-300">
                                    ...
                                    <motion.a href="https://github.com/Affanzuhaib" target="_blank">
                                        <span className="w-10 h-10 text-xl bg-bodyColor border-[1px]
                                        border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full 
                                        inline-flex items-center justify-center hover:text-textGreen 
                                        cursor-pointer hover:-translate-y-2 transition-all duration-300">
                                    ...
                                    <motion.a href="https://www.kaggle.com/affanzuhaib" target="_blank">
                                        <span className="w-10 h-10 text-xl bg-bodyColor border-[1px]
                                        border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full 
                                        inline-flex items-center justify-center hover:text-textGreen 
                                        cursor-pointer hover:-translate-y-2 transition-all duration-300">
                                    ...
                                    <motion.a href="https://www.codechef.com/users/cbit2_20_c137" target="_blank">
                                        <span className="w-10 h-10 text-xl bg-bodyColor border-[1px]
                                        border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full 
                                        inline-flex items-center justify-center hover:text-textGreen 
                                        cursor-pointer hover:-translate-y-2 transition-all duration-300 ">
